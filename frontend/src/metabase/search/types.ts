...
export type SearchSidebarFilterComponent<T extends FilterTypeKeys = any> = {
  Title: ComponentType<{ value: SearchFilterPropTypes[T] }>;
  Display: ComponentType<{ value: SearchFilterPropTypes[T] }>;
  Content: ComponentType<SearchFilterComponentProps<T>>;
};
